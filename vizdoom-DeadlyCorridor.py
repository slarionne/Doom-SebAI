...
class VizDoomGym(Env):
    ...
    def step(self, action):
        ...
        if self.game.get_state():
            ...
            hitcount_delta = hitcount - self.hit_count
...
class TrainAndLoggingCallback(BaseCallback):
    ...
    def _on_step(self):
        if self.n_calls % self.check_freq == 0:
            ...
            # model_path = os.path.join(self.save_path, 'model_2023{}'.format(self.n_calls))
            model_path = os.path.join(self.save_path, 'model_2023_s2{}'.format(self.n_calls))
...
model = PPO('CnnPolicy', env, tensorboard_log=LOG_DIR, verbose=1, n_steps=8192, clip_range=.1, gamma=.20, gae_lambda=0.60)
...
# model.load('./train/train_corridor/best_model_140000')
model.load('./train/train_corridor/model_2023_100000')
...
model.load('./train/train_corridor/best_model_50000')
...
model1 = PPO.load('./train/train_corridor/model_2023_s240000')
#PPO 3 is 400000
